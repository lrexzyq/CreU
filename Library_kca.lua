...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        function KeyPicker:GetState()
            ...
            elseif KeyPicker.Mode == 'Hold' then
                ...
                if Key == 'None' or Key == 'Unknown' or Key == 'Touch' then
                    return false
                elseif Key == 'MB1' then
        ...
        function KeyPicker:SetValue(Data)
            ...
            if Key == '' or Key == 'Touch' then
                Key = 'Unknown'
            end

            if type(Mode) ~= 'string' or not ModeButtons[Mode] then
                Mode = KeyPicker.Mode
            end
            if type(Mode) ~= 'string' or not ModeButtons[Mode] then
        ...
        local function BeginPicking()
            ...
            Event = InputService.InputBegan:Connect(function(Input)
                ...
                KeyPicker.Toggled = false;
                KeyPicker:Update();
                Library:SafeCallback(KeyPicker.ChangedCallback, Key == 'Unknown' and Enum.KeyCode.Unknown or Input.KeyCode or Input.UserInputType)
                Library:SafeCallback(KeyPicker.Changed, Key == 'Unknown' and Enum.KeyCode.Unknown or Input.KeyCode or Input.UserInputType)
    ...
    Funcs.Update = Funcs.Update or function(self)
        if self.Type == 'KeyPicker' and self._UpdateImpl then
            return self:_UpdateImpl()
        end
