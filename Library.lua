...
function Library:RenderCallSettings(Window)
    ...
    local ThemeGroup = SettingsTab:AddRightGroupbox('UI Colors')
    ThemeGroup:AddLabel('Accent Color'):AddColorPicker('AccentColorPicker', {
        Default = Library.AccentColor or Color3.fromRGB(0, 85, 255),
        Title = 'Accent Color',
        Callback = function(Value)
