...
['Creep'] = { 9, httpService:JSONDecode('{"FontColor":"c5c3c3","MainColor":"000000","AccentColor":"ffffff","BackgroundColor":"000000","OutlineColor":"27232f"}') },
	...
	function ThemeManager:ApplyTheme(theme)
		...
		local previousBatch = self.Library.BatchUpdating
		self.Library.BatchUpdating = true
		for idx, col in next, scheme do
			local ok, color = pcall(Color3.fromHex, tostring(col))
		...
		self.Library.BatchUpdating = previousBatch or false
